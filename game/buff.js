...
const BUFF_TYPES = {
  ...
  food_crit:   { name:'행운의 파이', stat:'critRate', add:0.08,  duration:180, icon:'food' },
  food_mp:     { name:'마나 양조',  stat:'maxMp',   add:50,    duration:300, icon:'food' },
  food_fire:   { name:'화염 수프',  stat:'atk',     add:20,    duration:120, icon:'food' },
  food_ice:    { name:'빙하 빙수',  stat:'def',     add:20,    duration:120, icon:'food' },
  food_king:   { name:'왕의 연회',  stat:'all',     add:15,    duration:300, icon:'food' },
  food_exp:    { name:'깨달음의 차', stat:'expMulti', multi:1.5, duration:300, icon:'food' },
