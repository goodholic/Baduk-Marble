...
public class GameManager : MonoBehaviour
{
    ...
    private void SpawnTerrain()
    {
        ...
        var zones = new string[][] {
            // 숲 지역 (서쪽)
            new[]{"forest", "-480","-450","150","130"},
            new[]{"forest", "-350","-380","120","100"},
            new[]{"forest", "-200","-200","100","90"},
            new[]{"forest", "-150","-350","90","80"},
            new[]{"forest", "-400","-280","100","80"},
            // 평원 지역 (남서쪽)
            new[]{"plains", "-400","-500","130","100"},
            new[]{"plains", "-200","-300","110","90"},
            new[]{"plains", "0","-350","100","80"},
            new[]{"plains", "-250","-150","90","70"},
            new[]{"plains", "-100","-450","80","60"},
            new[]{"plains", "100","-200","80","70"},
            // 던전 지역 (중앙)
            new[]{"dungeon","-450","-250","120","110"},
            new[]{"dungeon","-300","-250","110","100"},
            new[]{"dungeon","-150","-180","90","80"},
            new[]{"dungeon","0","-100","80","70"},
            // 드래곤 지역 (동쪽)
            new[]{"dragon", "80","0","150","130"},
            new[]{"dragon", "200","80","120","100"},
            new[]{"dragon", "30","-80","90","80"},
            new[]{"dragon", "300","150","100","80"},
            // 카오스 지역 (북쪽)
            new[]{"chaos",  "0","60","150","120"},
            new[]{"chaos",  "-150","60","100","90"},
            new[]{"chaos",  "100","180","100","80"},
            new[]{"chaos",  "-50","200","80","70"},
            // 마을 지역 (건물) — 5개 마을
            new[]{"village","-500","-500","90","90"},
            new[]{"village","320","-480","80","80"},
            new[]{"village","-130","-30","70","70"},
            new[]{"village","180","-320","70","70"},
            new[]{"village","-420","180","70","70"},
            // 시작 지역 (바람개비/해바라기) 근처 — 밀집
            new[]{"plains", "-500","-490","80","60"},
            new[]{"forest", "-480","-500","70","50"},
            new[]{"plains", "-420","-500","80","60"},
            new[]{"forest", "-360","-480","70","50"},
            // 추가 분산 지역
            new[]{"forest", "250","-100","80","70"},
            new[]{"dungeon","350","0","70","60"},
            new[]{"plains", "-300","100","80","70"},
            new[]{"chaos",  "200","300","80","70"},
        };
        ...
        foreach (var zone in zones)
        {
            ...
            int count = type == "village" ? 20 : 50 + (int)(UnityEngine.Random.value * 30);
